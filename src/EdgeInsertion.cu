                                                                                          ...
                                                                                          const std::shared_ptr<Config>& config)
{
  ...
  {
    d_edgeInsertion<VertexDataType, EdgeDataType, UpdateDataType> << < grid_size, block_size >> > ((MemoryManager*)memory_manager->d_memory,
  ...
  else if (config->testruns_.at(config->testrun_index_)->params->update_variant_ == ConfigurationParameters::UpdateVariant::WARPSIZED)
  {
    ...
    d_edgeInsertionWarpSized<VertexDataType, EdgeDataType, UpdateDataType> << < grid_size, block_size >> > ((MemoryManager*)memory_manager->d_memory,
                                                                                                            memory_manager->d_data,
                                                                                                            memory_manager->page_size,
                                                                                                            updates->d_edge_update,
                                                                                                            batch_size,
  ...
  else if (config->testruns_.at(config->testrun_index_)->params->update_variant_ == ConfigurationParameters::UpdateVariant::VERTEXCENTRIC)
  {
    ...
    d_edgeInsertionVertexCentric<VertexDataType, EdgeDataType, UpdateDataType> << < grid_size, block_size >> > ((MemoryManager*)memory_manager->d_memory,
                                                                                                               memory_manager->d_data,
                                                                                                               memory_manager->page_size,
                                                                                                               updates->d_edge_update,
                                                                                                               batch_size,
  ...
  else if (config->testruns_.at(config->testrun_index_)->params->update_variant_ == ConfigurationParameters::UpdateVariant::VERTEXCENTRICSORTED)
  {
    ...
    d_edgeInsertionVertexCentricSorted<VertexDataType, EdgeDataType, UpdateDataType> << < grid_size, block_size >> > ((MemoryManager*)memory_manager->d_memory,
                                                                                                                      memory_manager->d_data,
                                                                                                                      memory_manager->page_size,
                                                                                                                      updates->d_edge_update,
                                                                                                                      batch_size,
...
//
template void EdgeUpdateManager<VertexData, EdgeData, EdgeDataUpdate>::deviceEdgeInsertion (std::unique_ptr<MemoryManager>& memory_manager, const std::shared_ptr<Config>& config);
template void EdgeUpdateManager<VertexDataWeight, EdgeDataWeight, EdgeDataWeightUpdate>::deviceEdgeInsertion (std::unique_ptr<MemoryManager>& memory_manager, const std::shared_ptr<Config>& config);
template void EdgeUpdateManager<VertexDataSemantic, EdgeDataSemantic, EdgeDataSemanticUpdate>::deviceEdgeInsertion (std::unique_ptr<MemoryManager>& memory_manager, const std::shared_ptr<Config>& config);
template void EdgeUpdateManager<VertexData, EdgeDataSOA, EdgeDataUpdate>::deviceEdgeInsertion (std::unique_ptr<MemoryManager>& memory_manager, const std::shared_ptr<Config>& config);
template void EdgeUpdateManager<VertexDataWeight, EdgeDataWeightSOA, EdgeDataWeightUpdate>::deviceEdgeInsertion (std::unique_ptr<MemoryManager>& memory_manager, const std::shared_ptr<Config>& config);
template void EdgeUpdateManager<VertexDataSemantic, EdgeDataSemanticSOA, EdgeDataSemanticUpdate>::deviceEdgeInsertion (std::unique_ptr<MemoryManager>& memory_manager, const std::shared_ptr<Config>& config);
...
void EdgeUpdateManager<VertexDataType, EdgeDataType, UpdateDataType>::w_edgeInsertion(cudaStream_t& stream,
                     ...
                     int grid_size)
{
  d_edgeInsertion<VertexDataType, EdgeDataType, UpdateDataType> << < grid_size, block_size, 0, stream >> > ((MemoryManager*)memory_manager->d_memory,
                                                                                                            memory_manager->d_data,
                                                                                                            memory_manager->page_size,
...
template void EdgeUpdateManager<VertexData, EdgeData, EdgeDataUpdate>::w_edgeInsertion(cudaStream_t& stream, const std::unique_ptr<EdgeUpdateBatch<EdgeDataUpdate>>& updates_insertion, std::unique_ptr<MemoryManager>& memory_manager, int batch_size, int block_size, int grid_size);
template void EdgeUpdateManager<VertexDataWeight, EdgeDataWeight, EdgeDataWeightUpdate>::w_edgeInsertion(cudaStream_t& stream, const std::unique_ptr<EdgeUpdateBatch<EdgeDataWeightUpdate>>& updates_insertion, std::unique_ptr<MemoryManager>& memory_manager, int batch_size, int block_size, int grid_size);
template void EdgeUpdateManager<VertexDataSemantic, EdgeDataSemantic, EdgeDataSemanticUpdate>::w_edgeInsertion(cudaStream_t& stream, const std::unique_ptr<EdgeUpdateBatch<EdgeDataSemanticUpdate>>& updates_insertion, std::unique_ptr<MemoryManager>& memory_manager, int batch_size, int block_size, int grid_size);
template void EdgeUpdateManager<VertexData, EdgeDataSOA, EdgeDataUpdate>::w_edgeInsertion(cudaStream_t& stream, const std::unique_ptr<EdgeUpdateBatch<EdgeDataUpdate>>& updates_insertion, std::unique_ptr<MemoryManager>& memory_manager, int batch_size, int block_size, int grid_size);
template void EdgeUpdateManager<VertexDataWeight, EdgeDataWeightSOA, EdgeDataWeightUpdate>::w_edgeInsertion(cudaStream_t& stream, const std::unique_ptr<EdgeUpdateBatch<EdgeDataWeightUpdate>>& updates_insertion, std::unique_ptr<MemoryManager>& memory_manager, int batch_size, int block_size, int grid_size);
template void EdgeUpdateManager<VertexDataSemantic, EdgeDataSemanticSOA, EdgeDataSemanticUpdate>::w_edgeInsertion(cudaStream_t& stream, const std::unique_ptr<EdgeUpdateBatch<EdgeDataSemanticUpdate>>& updates_insertion, std::unique_ptr<MemoryManager>& memory_manager, int batch_size, int block_size, int grid_size);